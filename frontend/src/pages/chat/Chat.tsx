          ...
          <div className={styles.chatContainer}>
            {!messages || messages.length < 1 ? (
              <Stack className={styles.chatEmptyState}>
                ...
                <h2 className={styles.chatEmptyStateSubtitle}>{ui?.chat_description} <br> Brauchst du Hilfe? <a href='https://paraplegiech.sharepoint.com/sites/intra-knowledgebase-de/SitePages/SPGBotPrompting.aspx'>Klick hier </a></h2>
              </Stack>
            ) : (
